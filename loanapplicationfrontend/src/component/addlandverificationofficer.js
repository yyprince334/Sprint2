...
function Addlandverificationofficer() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (
        response.data.landverifyId !== "" ||
        response.data.landverifyId !== null
      ) {
      ...
      if (error.response && error.response.status === 404) {
        alert(
          "The officer is already there with this email try with another email"
        );
      } else {
        alert(
          "An error occurred while submitting the form check whether your entered the valid details according to the instruction."
        );
      }
    }
  };
      ...
      <div>
        <center>
          ...
          <form onSubmit={submitHandler}>
            ...
            />{" "}
            <br />
            <label>Land Verification Officer Name</label>
            <br />
            <input
              type="text"
              name="officerName"
            ...
            />{" "}
            <br />
            <label>Land Verification Officer MobileNumber</label>
            <br />
            <input
              type="text"
              name="officerContact"
