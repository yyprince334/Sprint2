...
const  LandVerificationOfficerUpdate = (props) => {
    ...
    const navigate = useNavigate();
            ...
            try {
              ...
              if (response.data.customerId !== "" || response.data.customerId !== null) {
                navigate("/viewloanforlandverification", { state: response.data });
        ...
        const submitCancelHandler = e=>{
          console.log(data);
            e.preventDefault();              
                    navigate("/viewloanforlandverification",{state:location.state});
    }
    ...
    return(
        <div><center>
            ...
            <p>Note:you can update only Land Verification </p>
            </form></center>
        </div>
    );
    }

export default LandVerificationOfficerUpdate;